...
# **List Data**
##### Description
This endpoint will return a list of public portfolios.

##### URL

`https://talentaccelerator.dev/api/v1/public/user-portfolios`
...
```shell
curl "https://talentaccelerator.dev/api/v1/public/user-portfolios" \
...
```shell
curl "http://127.0.0.1:8000/api/v1/public/user-portfolios" \
    -H "Content-Type: application/json"
```
